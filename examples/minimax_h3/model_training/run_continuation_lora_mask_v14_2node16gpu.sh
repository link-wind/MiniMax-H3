...
PRESET_LORA_PATH="${PRESET_LORA_PATH:-${REPO_ROOT}/models/MiniMaxH3/TrainingAdapter/model.safetensors}"
...
if [[ ! -f "${PRESET_LORA_PATH}" ]]; then
  echo "[error] TrainingAdapter not found: ${PRESET_LORA_PATH}" >&2
  exit 1
fi
...
ARGS=(
  ...
  --model_id_with_origin_paths "MiniMaxH3:FL2VA/text_encoder/model*.safetensors,MiniMaxH3:FL2VA/video_vae/source/model.safetensors,MiniMaxH3:FL2VA/audio_vae/model.safetensors,MiniMaxH3:FL2VA/transformer/model*.safetensors"
